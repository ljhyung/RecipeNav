        ...
        <div style={{
            ...
            <Row>
                <Col md={24} xs={0}>
                    <header>
                    <QueueAnim >
                        <Link className="logo" to='/' style={{backgroundColor:"red" }} ref={logop}>
                            <img alt="logo" src={LogoMain} />
                        </Link>
                        <Row className="nav">
                            <Col span={4}>
                                <Tooltip placement="bottom" overlayClassName="header-tip-wrap" >
                                    <Link to="/ingredient" className="nav-title" ref={ingp}>식자재</Link>
                                </Tooltip>
                            </Col>
                            <Col span={4}>
                                <Tooltip placement="bottom" overlayClassName="header-tip-wrap" >
                                    <Link to="/recipe" className="nav-title" ref={recipep} >레시피</Link>
                                </Tooltip>
                            </Col>
                            <Col span={4}>
                                <Tooltip placement="bottom" overlayClassName="header-tip-wrap">
                                    <Link to="/budget" className="nav-title" ref={budgetp}>예산</Link>
                                </Tooltip>
                            </Col>
                            <Col span={4}>
                                <Tooltip placement="bottom" overlayClassName="header-tip-wrap">
                                    <Link to="/mypage" className="nav-title" ref={myPagep}>MyPage</Link>
                                </Tooltip>
                            </Col>
