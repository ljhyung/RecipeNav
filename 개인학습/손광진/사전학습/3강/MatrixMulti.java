...
public class MatrixMulti {
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 7) {
			System.err.println("Usage : <Matrix 1 name> <Matrix 2 name> <Number of rows in Matrix 1> <Number of columns in Matrix (o.e., Nuber of rows in Matrix 2)> <Number of columns in Matrix 2> <in> < out>");
