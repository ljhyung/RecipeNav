...
public class UserController {
    ...
    public ResponseEntity<?> jwtAuthorization(@RequestHeader(name = "") String accessToken){

        UserDto onlySeqAndIdDto = jwtService.ParseJwt(accessToken);

        UserDto resultDto = userService.getUserInfo(onlySeqAndIdDto);
